...
var MeCarouselView = Backbone.View.extend({
    ...
    initialize: function(model, options) {
        _.bindAll(this, 'render', 'onChangeClothing', 'onSwipeLeft', 'onSwipeRight', 'onSwipeUp', 'onSwipeDown', 'recalcPrice');
        var that = this;
    ...
    recalcPrice : function(){
        ...
        var total = (topProduct.price + bottomProduct.price+ shoesProduct.price);
